    ...
    <div className="relative min-h-[calc(100vh-4rem)] flex flex-col justify-center items-center overflow-hidden bg-background">
      ...
      <section className="container relative z-10 mx-auto px-4 flex flex-col items-center justify-center space-y-10 text-center pb-16 pt-8 md:pt-0">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-x-8 gap-y-2 md:gap-y-4">
          <h1 className="text-[10rem] md:text-[14rem] leading-none font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-primary-300 via-primary-500 to-primary-700 drop-shadow-sm select-none pr-4 md:pr-8">
            GO
          </h1>

          <div className="flex flex-col text-center md:text-left justify-center mt-2 md:mt-0">
            <h2 className="text-6xl md:text-8xl font-black italic tracking-tight text-foreground leading-[0.85]">
              FURTHER
            </h2>
            ...
            <h2 className="text-5xl md:text-7xl font-bold italic tracking-tight text-foreground/70 leading-[0.85]">
              FOR LESS
            </h2>
          </div>
        </div>
